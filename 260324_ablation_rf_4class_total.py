...
class Config:
    ...
    RESULTS_DIR = "260324_Results_RF_MultiExperiment_Ablation"
...
if __name__ == "__main__":
    ...
    print("=" * 100)
    print("🚀 STARTING RANDOM FOREST MULTI-EXPERIMENT ABLATION (FILE-BASED STRATIFIED SPLIT)")
    print("=" * 100)
    ...
    for exp_name, exp_cfg in Config.EXPERIMENTS.items():
        ...
        for abl_name, abl_cfg in ablation_configs.items():
            ...
            print("\n" + "=" * 100)
            print(f"🚀 STARTING RANDOM FOREST EXPERIMENT: {exp_name}")
            ...
            print("\n" + "=" * 80)
            print(f"📊 FINAL RANDOM FOREST SUMMARY [{exp_name} | {abl_name}]")
            print("=" * 80)
            write_log(log_file, "\n" + "=" * 80, print_console=False)
            write_log(log_file, f"FINAL RANDOM FOREST SUMMARY [{exp_name} | {abl_name}]", print_console=False)
            ...
            pd.DataFrame(summary_results).to_csv(
                os.path.join(Config.RESULTS_DIR, "ablation_summary_rf.csv"),
                index=False,
                encoding='utf-8-sig'
            )
