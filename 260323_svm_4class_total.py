...
class Config:
    ...
    RESULTS_DIR = "260323_Results_SVM_MultiExperiment"
...
def plot_kfold_summary(final_results, save_dir, experiment_name):
    ...
    plt.tight_layout()
    save_path = os.path.join(save_dir, "KFold_Summary_SVM_FileBasedSplit.png")
    plt.savefig(save_path, dpi=300)
    plt.close()
...
if __name__ == "__main__":
    ...
    print("=" * 100)
    print("🚀 STARTING SVM MULTI-EXPERIMENT (FILE-BASED STRATIFIED SPLIT)")
    print("=" * 100)
    ...
    for exp_name, exp_cfg in Config.EXPERIMENTS.items():
        ...
        with open(log_file, 'w', encoding='utf-8') as f:
            ...
            f.write(f"SVM Params      : {Config.SVM_PARAMS}\n")
            f.write("=" * 80 + "\n")
        ...
        print("\n" + "=" * 80)
        print(f"📊 FINAL SVM SUMMARY [{exp_name}]")
        print("=" * 80)
        write_log(log_file, "\n" + "=" * 80, print_console=False)
        write_log(log_file, f"FINAL SVM SUMMARY [{exp_name}]", print_console=False)
        ...
        plot_kfold_summary(final_results, exp_result_dir, f"{exp_name} - SVM File-Based Split")
